...
(function() {
    ...
    function init() {
        ...
        function render() {
            ...
            gridEl.innerHTML = list.map(g => `
                <div class="card-game">
                    <div class="card-bg">
                        <img src="${g.bg}" alt="${g.title}" loading="lazy"
                             onerror="this.src='https://placehold.co/600x800/1a1a1e/white?text=${g.title}'">
                    </div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-details">
                                ...
                                <div class="card-action"
                                     onclick="window.open('${g.trailer}', '_blank')"
            ...
            gridEl.querySelectorAll('.card-game').forEach(card => observer.observe(card));
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (window.TRANSITION_ACTIVE) {
            window.addEventListener('transitionDone', init, { once: true });
        } else {
            init();
        }
    });
